...
export default function Sessions() {
  ...
  return (
    <div className="px-5 py-8 font-mono text-[12px]">
      ...
      <p className="mt-2 max-w-3xl text-cream-2">
        Tick a shot to flip its exclusion, then paste the generated block into{" "}
        <code className="text-cream-0">data/exclusions.json</code> and re-run{" "}
        <code className="text-cream-0">pnpm ingest</code>. Nothing is written from
        the browser — the ledger is files, and a checkbox that pretended to
        persist would be lying.
      </p>
      <p className="mt-2 max-w-3xl text-cream-3">
